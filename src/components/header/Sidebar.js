...
class Sidebar extends Component {
    ...
    render() {
        return (
            <div className="sidebar_container" style={this.state.isClicked? {right: '-47px'} : {right: '-120px'}}>
                <svg className="svg_container" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 310" width="150px" >
                    <path className={this.state.isClicked ? "svg_fill_out" : "svg_fill_in"}
                        strokeMiterlimit="10"
                        d="M43.59 0.88L43.59 73.18 0.78 73.18 0.78 236.82 43.59 236.82 43.59 309.12 214.22 309.12 214.22 0.88 43.59 0.88z"
                    >
                    </path>
                </svg>
                <div className="sidebar_arrow_container" onClick={this.handleOpen} style={{ transform: `${this.state.isClicked? "scale(-1)" : "scale(1)"}` }}>
